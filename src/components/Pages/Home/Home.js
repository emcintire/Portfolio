...
function Home() {
    ...
    const clickContact = () => {
        if (!showContact) {
            ...
            toast(<div><img src={emoji} alt="weary face" id="emoji"/>Copied to Clipboard!</div>);
        } else {
            setShowContact(!showContact)
        }
    }
